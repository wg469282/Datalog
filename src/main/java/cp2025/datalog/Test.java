...
public class Test
{
  ...
  public Test(String[] args)
  {
    try
    {
      ...
      l = new DatalogLexer(CharStreams.fromReader(input));
    ...
    p = new DatalogParser(new CommonTokenStream(l));
            p.addErrorListener(new BNFCErrorListener());
  }

  public cp2025.datalog.Absyn.ProgramDef parse() throws Exception
  {
    /* The default parser is the first-defined entry point. */
    DatalogParser.Start_ProgramDefContext pc = p.start_ProgramDef();
    cp2025.datalog.Absyn.ProgramDef ast = pc.result;
    System.out.println();
